...
**First in Bastogne** to taktyczna gra akcji 2D osadzona podczas zimowej ofensywy w Ardenach. Gracz obejmuje dowództwo nad słynnym czołgiem **Cobra King** i bierze udział w desperackiej drodze ku Bastogne, gdzie każda decyzja, każdy strzał i każdy manewr mogą przesądzić o przeżyciu załogi.
...
- kampania inspirowana bitwą o Bastogne i zimową ofensywą 1944 roku,
...
| RAM | 8 GB | 16 GB |
| Miejsce na dysku | 500 MB | 500 MB |
